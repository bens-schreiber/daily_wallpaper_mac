...
set imageURL to "https://www.bing.com/" & (do shell script "echo " & quoted form of json & " | jq -r '.images[0].url'")
set copyright to (do shell script "echo " & quoted form of json & " | jq -r '.images[0].copyright'")
set jdate to (do shell script "echo " & quoted form of json & " | jq -r '.images[0].startdate'")
